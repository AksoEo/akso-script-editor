...
const config = {
    ...
    peek: {
        background: [0.2, 0.2, 0.2, 1] as RawVec4,
    },
    ...
    primitives: {
        ...
        colorH: [1, 1, 1, 1] as RawVec4,
        color0: [0, 0, 0, 0] as RawVec4,
        trueNameColor: [0, 0, 0, 0.5] as RawVec4,
        iconColor: [0, 0, 0, 0.7] as RawVec4,
        iconColor0: [0, 0, 0, 0] as RawVec4,
        refOnlyColor: [0, 0, 0, 0.5] as RawVec4,

        error: [1, 0.3, 0.4, 1] as RawVec4,
        errorOutline: [0.3, 0, 0, 1] as RawVec4,
        errorColor: [1, 1, 1, 1] as RawVec4,

        ref: [1, 1, 1, 1] as RawVec4,
        refOutline: [0.9, 0.3, 0.6, 1] as RawVec4,
        refBroken: [1, 0.3, 0.4, 1] as RawVec4,
        refBrokenOutline: [0.3, 0, 0, 1] as RawVec4,
        null: [1, 1, 1, 1] as RawVec4,
        nullOutline: [0.73, 0.13, 0.25, 1] as RawVec4,
        bool: [1, 1, 1, 1] as RawVec4,
        boolOutline: [0.83, 0.48, 0.05, 1] as RawVec4,
        number: [1, 1, 1, 1] as RawVec4,
        numberOutline: [0.9, 0.73, 0, 1] as RawVec4,
        string: [1, 1, 1, 1] as RawVec4,
        stringOutline: [0.4, 0.82, 0, 1] as RawVec4,
        stringHighlight: [0.1, 0.62, 0, 1] as RawVec4, // dropdown hilight
        matrix: [1, 1, 1, 1] as RawVec4,
        matrixOutline: [0, 0.85, 0.58, 1] as RawVec4,
        list: [1, 1, 1, 1] as RawVec4,
        listOutline: [0, 0.76, 0.9, 1] as RawVec4,
        call: [1, 1, 1, 1] as RawVec4,
        callOutline: [0.9, 0, 0.34, 1] as RawVec4,
        callHoverOutline: [0.8, 0, 0.24, 1] as RawVec4,
        func: [1, 1, 1, 1] as RawVec4,
        funcOutline: [0.8, 0.5, 0.5, 1] as RawVec4,
        switch: [1, 1, 1, 1] as RawVec4,
        switchOutline: [0.5, 0.5, 0.8, 1] as RawVec4,
        timestamp: [1, 1, 1, 1] as RawVec4,
        timestampOutline: [0.82, 0.5, 0.38, 1] as RawVec4,
    ...
    matrix: {
        ...
        selectionColor: [0.1, 0.3, 0.6, 1] as RawVec4,
        selectionBoundSize: 8,
        selectionOutlineWidth: 2,

        tableHeader: {
            background: [0.9, 0.9, 0.9, 1] as RawVec4,
            delete: [1, 0.3, 0.1, 1] as RawVec4,
            deleteIdle: [1, 0.3, 0.1, 0] as RawVec4,
            deleteColor: [1, 1, 1, 1] as RawVec4,
            deleteColorIdle: [0, 0, 0, 0.7] as RawVec4,
        },
        tableExtension: {
            background: [0.3, 0.9, 0.1, 1] as RawVec4,
            backgroundIdle: [0.9, 0.9, 0.9, 1] as RawVec4,
            color: [0, 0, 0, 1] as RawVec4,
            colorIdle: [0, 0, 0, 0.6] as RawVec4,
        },
        cellTypes: {
            null: 'NUL',
            bool: 'buleo',
    ...
    exprSlot: {
        weight: 2,
        hoverWeight: 4,
        stroke: [0.5, 0.5, 0.5, 0] as RawVec4,
        emptyStroke: [0.5, 0.5, 0.5, 1] as RawVec4,
        hoverStroke: [0.2, 0.2, 0.2, 1] as RawVec4,
        background: [0, 0, 0, 0] as RawVec4,
        hoverBackground: [0, 0, 0, 0.2] as RawVec4,
    },

    trash: {
        title: 'Tiru tien ĉi por forigi',
        background: [0.7, 0.7, 0.7, 0.4] as RawVec4,
        activeBackground: [1, 0.3, 0.2, 0.5] as RawVec4,
        bigBackground: [0.95, 0.95, 0.95, 0.5] as RawVec4,
        bigActiveBackground: [1, 0.3, 0.2, 0.4] as RawVec4,

        fill: [0.75, 0.75, 0.75, 1] as RawVec4,
        fillLines: [0, 0, 0, 0.5] as RawVec4,
        outline: [0, 0, 0, 1] as RawVec4,
        outlineWidth: 1,
        iconSize: 24,
        lid: {
    ...
    toolbar: {
        background: [0.7, 0.7, 0.7, 1] as RawVec4,
        button: {
            background: [0.8, 0.8, 0.8, 1] as RawVec4,
            activeBackground: [0.5, 0.5, 0.5, 1] as RawVec4,
            color: [0, 0, 0, 1] as RawVec4,
            outlineWidth: 2,
            outline: [1, 1, 1, 0] as RawVec4,
            hoverOutline: [1, 1, 1, 1] as RawVec4,
            activeOutline: [0, 0, 0, 1] as RawVec4,
            paddingX: 7,
            paddingY: 3,

            pbackground: [0.2, 0.2, 0.2, 1] as RawVec4,
            pactiveBackground: [0, 0, 0, 1] as RawVec4,
            pcolor: [1, 1, 1, 1] as RawVec4,
            poutline: [0, 0.76, 0.9, 0] as RawVec4,
            phoverOutline: [0, 0.76, 0.9, 1] as RawVec4,
            pactiveOutline: [0.1, 0.9, 1, 1] as RawVec4,
        },
        buttons: {
            code: 'Kodo',
            graph: 'Grafeo',
        ...
        versionColor: [0, 0, 0, 0.5] as RawVec4,
    },

    scrollbar: {
        margin: 2,
        size: 8,
        background: [0, 0, 0, 0.1] as RawVec4,
        thumb: [0, 0, 0, 0.3] as RawVec4,
        hoverThumb: [0, 0, 0, 0.5] as RawVec4,
        minThumbSize: 16,
    },
    ...
    library: {
        ...
        background: [0.95, 0.95, 0.95, 1] as RawVec4,
        sideTabs: {
            background: [0.6, 0.6, 0.6, 1] as RawVec4,
            tab: [0.7, 0.7, 0.7, 1] as RawVec4,
            activeTab: [0.95, 0.95, 0.95, 1] as RawVec4,
        },
    },
    ...
    formVars: {
        ...
        add: {
            ...
            color: [0, 0, 0, 1] as RawVec4,
            noColor: [0, 0, 0, 0] as RawVec4,
            activeBackground: [0.5, 0.5, 0.5, 1] as RawVec4,
        },
        remove: {
            color: [1, 1, 1, 1] as RawVec4,
            background: [0.9, 0, 0.34, 1] as RawVec4,
            activeBackground: [0.7, 0, 0.14, 1] as RawVec4,
        },
        color: [0, 0, 0, 1] as RawVec4,
        background: [0.8, 0.8, 0.8, 1] as RawVec4,
        insetY: 4,
